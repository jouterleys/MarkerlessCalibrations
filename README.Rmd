...
```{r img_objectcalibrations, echo=FALSE, fig.align = 'center', out.width = "50%", fig.cap = "A: Lframe with Floor Points. B:Prism Corners with Floor Points. C:Prism Markers with Floor Points. D: FloorGrid 12pts."}
